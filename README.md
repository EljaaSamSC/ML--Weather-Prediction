...
features = ['hum', 'pressure', 'wind_speed', 'illumination', 'co2','hour_sin', 'hour_cos', 'tem_lag1', 'pm2_5_lag1', 'tsr_lag1']
...
models = {}
results = {}
target_meta = {'tem': ('Temperature', '°C', 'red'),'pm2_5': ('Pollution (PM2.5)', 'µg/m³', 'green'),'tsr': ('Energy (Solar Radiation)', 'W/m²', 'orange')}
for target in targets:
    ...
    models[target] = model
    results[target] = {'r2': r2_score(y_test, preds),'mae': mean_absolute_error(y_test, preds),'preds': preds,'actual': y_test.values}
...
<img width="1271" height="585" alt="image" src="https://github.com/user-attachments/assets/d86628a7-be30-4bb8-9627-4861c314b041" />
<img width="1332" height="467" alt="image" src="https://github.com/user-attachments/assets/ce98b732-3bc7-494c-995f-46c761a57203" />
